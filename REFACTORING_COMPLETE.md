...
### 2. 字体系统
- **字体家族**: 从 sohne-var 更改为 Airbnb Cereal VF
- **字重范围**: 从 300-400 更改为 500-700 (温暖、自信的视觉风格)
- **字间距**: 标题使用负值字间距 (-0.18px 到 -0.44px)
- **OpenType特性**: 从 ss01 更改为 salt (stylistic alternates)

### 3. 阴影系统
采用Airbnb三层阴影系统，营造温暖、自然的提升感：
```css
/* Level 1 - 卡片阴影 */
...
### 移除/弃用的组件
- `BrandSection.tsx` - 不再需要
- `FeatureGrid.tsx` - 被ComparisonMatrix替代
- `CTAButton.tsx` - 被ContextualCTA替代
