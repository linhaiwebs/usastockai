...
/**
 * Usage Stats Bar - Mobile-first design
 * Shows today's diagnosis count with Airbnb style
 */
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              >
                You've done <span className="font-semibold text-rausch">{diagnosesUsed}</span> diagnoses today
              </p>
              <p 
