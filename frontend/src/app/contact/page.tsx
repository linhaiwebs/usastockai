    ...
    <div className="min-h-screen bg-background text-on-background">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="space-y-6 font-body text-on-surface-variant leading-relaxed text-sm">
          ...
          <section className="bg-surface-container-lowest p-6 rounded-xl shadow-[0_4px_20px_rgba(19,27,46,0.04)] border border-outline-variant/15 space-y-4">
            <div className="flex items-center gap-3">
              <span className="material-symbols-outlined text-primary">mail</span>
              <div>
                <p className="font-label text-[10px] text-on-surface-variant uppercase tracking-widest mb-1">Email</p>
                <p className="text-on-surface">support@qstock.com</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <span className="material-symbols-outlined text-primary">chat</span>
              <div>
                <p className="font-label text-[10px] text-on-surface-variant uppercase tracking-widest mb-1">WhatsApp</p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-label text-[10px] text-on-surface-variant uppercase tracking-widest mb-1">Response Time</p>
