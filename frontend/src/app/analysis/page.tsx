  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-28 pb-20 px-6 max-w-screen-xl mx-auto">
        ...
        {/* Model Info */}
        <div className="glass-panel rounded-2xl border border-white/[0.05] p-6 mb-8">
        ...
        <div className="mb-12">
          ...
          <div className="flex flex-col gap-4">
            {[
              ...
              <div key={item.format} className="glass-panel rounded-2xl border border-white/[0.05] p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {item.vars.split(', ').map((v) => (
                    <span key={v} className="text-[9px] px-2 py-0.5 rounded bg-primary/10 text-[#99f7ff] font-mono">{v}</span>
                  ))}
                </div>
              </div>
            ))}
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              <div key={item.title} className="glass-panel rounded-xl border border-white/[0.05] p-5 flex gap-4">
