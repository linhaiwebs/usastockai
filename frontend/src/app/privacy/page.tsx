  ...
  return (
    <div className="min-h-screen bg-background text-on-background">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        <h1 className="text-3xl font-headline font-bold text-primary mb-8">Privacy Policy</h1>
        <div className="space-y-6 font-body text-on-surface-variant leading-relaxed text-sm">
          ...
          <section>
            ...
            <p>You have the right to access, correct, or delete your personal data. You may opt out of analytics tracking at any time. To exercise these rights, please contact us through our support page.</p>
          </section>
          <section>
