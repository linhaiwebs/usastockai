  ...
  return (
    <div className="min-h-screen bg-background text-on-background">
      ...
      <main className="max-w-2xl mx-auto px-6 py-12">
        <h1 className="text-3xl font-extrabold text-on-surface mb-8">Privacy Policy</h1>
        <div className="space-y-6 text-on-surface-variant leading-relaxed text-sm">
          <section>
            <h2 className="font-bold text-on-surface text-lg mb-3">1. Information We Collect</h2>
          ...
          <section>
            <h2 className="font-bold text-on-surface text-lg mb-3">2. How We Use Your Data</h2>
          ...
          <section>
            <h2 className="font-bold text-on-surface text-lg mb-3">3. Data Sharing</h2>
          ...
          <section>
            <h2 className="font-bold text-on-surface text-lg mb-3">4. Data Security</h2>
          ...
          <section>
            <h2 className="font-bold text-on-surface text-lg mb-3">5. Your Rights</h2>
            <p>You have the right to access, correct, or delete your personal data. You may opt out of analytics tracking at any time.</p>
          </section>
          <section>
            <h2 className="font-bold text-on-surface text-lg mb-3">6. Cookies</h2>
