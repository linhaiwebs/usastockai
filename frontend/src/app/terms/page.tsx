          ...
          <div className="space-y-10">
            <section>
              ...
              <p className="text-on-surface-variant leading-relaxed text-sm">
                By accessing or using STOCK_INTEL (&quot;the Service&quot;), you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use the Service. These terms apply to all visitors, users, and others who access the Service.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-on-surface-variant leading-relaxed text-sm">
                STOCK_INTEL provides AI-powered stock analysis and market intelligence tools. The Service generates automated analysis reports based on market data and artificial intelligence models. All analysis provided is for informational purposes only and should not be considered as financial advice, investment recommendations, or solicitations to buy or sell securities.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-on-surface-variant leading-relaxed text-sm">
                To the maximum extent permitted by law, STOCK_INTEL shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of the Service, any errors or inaccuracies in the analysis provided, any interruption or cessation of the Service, or any financial losses resulting from investment decisions made based on information from the Service.
              </p>
            </section>
