          ...
          <div className="space-y-10">
            <section>
              ...
              <p className="text-on-surface-variant leading-relaxed text-sm">
                By accessing or using STOCK_DIAGNOSTIC (&quot;the Service&quot;), you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use the Service. These terms apply to all visitors, users, and others who access the Service.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-on-surface-variant leading-relaxed text-sm">
                STOCK_DIAGNOSTIC provides AI-powered stock analysis and market intelligence tools. The Service generates automated analysis reports based on market data and artificial intelligence models. All analysis provided is for informational purposes only and should not be considered as financial advice, investment recommendations, or solicitations to buy or sell securities.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="glass-card p-6 rounded-2xl border-l-4 border-secondary/50 mb-4">
                <p className="text-on-surface leading-relaxed text-sm font-medium">
                  ⚠️ IMPORTANT: STOCK_DIAGNOSTIC does not provide financial advice, investment advice, or any form of professional advisory services. The AI-generated stock analysis is based on computational models and historical data, which may not predict future market performance. Always consult a qualified financial advisor before making investment decisions.
                </p>
              </div>
              <p className="text-on-surface-variant leading-relaxed text-sm">
                Past performance is not indicative of future results. Stock markets are inherently volatile and unpredictable. You acknowledge that any investment decisions made based on information from STOCK_DIAGNOSTIC are made at your own risk.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-on-surface-variant leading-relaxed text-sm">
                All content, features, and functionality of STOCK_DIAGNOSTIC — including but not limited to text, graphics, logos, design elements, AI models, and software — are owned by STOCK_DIAGNOSTIC and protected by international copyright, trademark, and other intellectual property laws. You may not reproduce, distribute, modify, or create derivative works without explicit written permission.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-on-surface-variant leading-relaxed text-sm">
                To the maximum extent permitted by law, STOCK_DIAGNOSTIC shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of the Service, any errors or inaccuracies in the analysis provided, any interruption or cessation of the Service, or any financial losses resulting from investment decisions made based on information from the Service.
              </p>
            </section>
